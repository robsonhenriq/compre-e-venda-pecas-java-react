  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="ecommerceApp.avaliacao.delete.question">
          <Translate contentKey="ecommerceApp.avaliacao.delete.question" interpolate={{ id: avaliacaoEntity.id }}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-avaliacao" color="danger" onClick={this.confirmDelete}>
