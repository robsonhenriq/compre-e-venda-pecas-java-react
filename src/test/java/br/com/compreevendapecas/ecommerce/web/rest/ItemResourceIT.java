...
public class ItemResourceIT {
    ...
    public void createItem() throws Exception {
        ...
        assertThat(testItem.getValorTotal()).isEqualTo(DEFAULT_VALOR_TOTAL);
    ...
    @Test
    @Transactional
    public void checkValorItemIsRequired() throws Exception {
        int databaseSizeBeforeTest = itemRepository.findAll().size();
        // set the field null
    ...
    public void updateItem() throws Exception {
        ...
        Item testItem = itemList.get(itemList.size() - 1);
        assertThat(testItem.getValorTotal()).isEqualTo(UPDATED_VALOR_TOTAL);
