...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    it('should set state to loading', () => {
      testMultipleTypes([REQUEST(ACTION_TYPES.FETCH_AVALIACAO_LIST), REQUEST(ACTION_TYPES.FETCH_AVALIACAO)], {}, state => {
        expect(state).toMatchObject({
          errorMessage: null,
          updateSuccess: false,
          loading: true
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [REQUEST(ACTION_TYPES.CREATE_AVALIACAO), REQUEST(ACTION_TYPES.UPDATE_AVALIACAO), REQUEST(ACTION_TYPES.DELETE_AVALIACAO)],
        {},
        state => {
          expect(state).toMatchObject({
            errorMessage: null,
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.DELETE_AVALIACAO)
        ],
        'error message',
        state => {
          expect(state).toMatchObject({
  ...
  describe('Successes', () => {
    ...
    it('should fetch a single entity', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.FETCH_AVALIACAO),
          payload
        })
      ).toEqual({
        ...initialState,
    ...
    it('should delete entity', () => {
      ...
      const toTest = reducer(undefined, {
        type: SUCCESS(ACTION_TYPES.DELETE_AVALIACAO),
        payload
      });
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.FETCH_AVALIACAO_LIST actions', async () => {
    ...
    it('dispatches ACTION_TYPES.FETCH_AVALIACAO actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.FETCH_AVALIACAO)
        },
        {
          type: SUCCESS(ACTION_TYPES.FETCH_AVALIACAO),
          payload: resolvedObject
    ...
    it('dispatches ACTION_TYPES.DELETE_AVALIACAO actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.DELETE_AVALIACAO)
        },
        {
          type: SUCCESS(ACTION_TYPES.DELETE_AVALIACAO),
          payload: resolvedObject
